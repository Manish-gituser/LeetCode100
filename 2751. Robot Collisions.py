...
class Solution:
    ...
    def survivedRobotsHealths(self, positions: List[int], healths: List[int], directions: str) -> List[int]:
        ...
        robots = [self.Robot(i, positions[i], healths[i], directions[i]) for i in range(n)]
        ...
        for robot in robots:
            if robot.direction == 'R':
                ...
                self.handleCollisions(st, robot)

        # store remaining robots in stack in a list
        robots = st
        ...
        ans = [robot.health for robot in robots]
